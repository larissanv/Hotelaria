 ...
 * @generated
 */
public class SuperItemProvider 
	...
	public String getText(Object object) {
		String label = ((Super)object).getNome();
		return label == null || label.length() == 0 ?
			getString("_UI_Super_type") :
