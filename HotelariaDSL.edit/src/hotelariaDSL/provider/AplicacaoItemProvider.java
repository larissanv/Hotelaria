 ...
 * @generated
 */
public class AplicacaoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Aplicacao_titulo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Aplicacao_titulo_feature", "_UI_Aplicacao_type"),
				 HotelariaDSLPackage.Literals.APLICACAO__TITULO,
				 true,
				 false,
				 false,
