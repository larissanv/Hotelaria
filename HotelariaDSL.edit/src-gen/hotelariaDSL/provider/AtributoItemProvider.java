...
/**
 * This is the item provider adapter for a {@link hotelariaDSL.Atributo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtributoItemProvider extends SuperItemProvider {
	/**
	...
	protected void addNomeAtributoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Atributo_nomeAtributo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Atributo_nomeAtributo_feature",
								"_UI_Atributo_type"),
						HotelariaDSLPackage.Literals.ATRIBUTO__NOME_ATRIBUTO, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Atributo_tipo_feature",
								"_UI_Atributo_type"),
						HotelariaDSLPackage.Literals.ATRIBUTO__TIPO, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Atributo) object).getTitulo();
