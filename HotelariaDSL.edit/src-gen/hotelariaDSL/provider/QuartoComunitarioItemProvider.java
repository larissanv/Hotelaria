 ...
 * @generated
 */
public class QuartoComunitarioItemProvider extends SuperItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((QuartoComunitario) object).getTitulo();
		return label == null || label.length() == 0 ? getString("_UI_QuartoComunitario_type")
