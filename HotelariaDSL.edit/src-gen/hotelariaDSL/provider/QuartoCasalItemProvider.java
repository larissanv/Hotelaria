 ...
 * @generated
 */
public class QuartoCasalItemProvider extends SuperItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((QuartoCasal) object).getTitulo();
		return label == null || label.length() == 0 ? getString("_UI_QuartoCasal_type")
