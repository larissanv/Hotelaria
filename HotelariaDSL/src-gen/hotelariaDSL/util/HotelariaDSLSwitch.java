...
public class HotelariaDSLSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HotelariaDSLPackage.PESSOA: {
			...
			if (result == null)
				result = caseSuper(pessoa);
			if (result == null)
				result = caseAplicacao(pessoa);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.HOSPEDE: {
			...
			if (result == null)
				result = casePessoa(hospede);
			if (result == null)
				result = caseSuper(hospede);
			if (result == null)
				result = caseAplicacao(hospede);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.RECEPCIONISTA: {
			...
			if (result == null)
				result = casePessoa(recepcionista);
			if (result == null)
				result = caseSuper(recepcionista);
			if (result == null)
				result = caseAplicacao(recepcionista);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.QUARTO: {
			...
			if (result == null)
				result = caseSuper(quarto);
			if (result == null)
				result = caseAplicacao(quarto);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.QUARTO_SOLTEIRO: {
			...
			if (result == null)
				result = caseQuarto(quartoSolteiro);
			if (result == null)
				result = caseSuper(quartoSolteiro);
			if (result == null)
				result = caseAplicacao(quartoSolteiro);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.QUARTO_COMUNITARIO: {
			...
			if (result == null)
				result = caseQuarto(quartoComunitario);
			if (result == null)
				result = caseSuper(quartoComunitario);
			if (result == null)
				result = caseAplicacao(quartoComunitario);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelariaDSLPackage.QUARTO_CASAL: {
			...
			if (result == null)
				result = caseQuarto(quartoCasal);
			if (result == null)
				result = caseSuper(quartoCasal);
			if (result == null)
				result = caseAplicacao(quartoCasal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HotelariaDSLPackage.ATRIBUTO: {
			...
			if (result == null)
				result = caseSuper(atributo);
			if (result == null)
				result = caseAplicacao(atributo);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
